...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        Rock rock1;
        Rock rock2;
        string greenrock = @"graphics\greenrock";
        string magentarock = @"graphics\magentarock";
        string whiterock = @"graphics\whiterock";
        // delay support
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedDelayMilliseconds >= TotalDelayMilliseconds)
            {
                ...
                if(isNull(rock0) || isNull(rock1) || isNull(rock2))
                {
                    rock0 = GetRandomRock();
                    rock1 = GetRandomRock();
                    rock2 = GetRandomRock();
